...
public class LightsTests {
    ...
    public void sphereSpotSharp() {
        scene1.geometries.add(sphere);
        scene1.lights
                .add(new FlashLight(sphereLightColor, sphereLightPosition, new Vector(1, 1, -0.5), 30)
                        .setKl(0.001).setKq(0.00004));
        //.setKl(0.001).setKq(0.00004).setNarrowBeam(10));

        camera1.setImageWriter(new ImageWriter("lightSphereFashLight", 500, 500))
                .build()
                .renderImage()
                .writeToImage();
    }
    ...
    public void trianglesSpotSharp() {
        scene2.geometries.add(triangle1, triangle2);
        scene2.lights.add(new FlashLight(trianglesLightColor, trianglesLightPosition, trianglesLightDirection, 30)
                .setKl(0.001).setKq(0.00004));
        //.setKl(0.001).setKq(0.00004).setNarrowBeam(10));

        camera2.setImageWriter(new ImageWriter("lightTrianglesFashLight", 500, 500))
                .build()
                .renderImage()
                .writeToImage();
    }
    ...
    public void miscellaneousTests() {
        ...
        //----------------------geometries----------------------
        material1.setKd(0.4d).setKs(4d).setShininess(200);
        ...
        DirectionalLight directionalLight2 = new DirectionalLight(
                new Color(33, 5, 3), Vector.BACKWARDS);
        ...
        //----------------------camera----------------------
        camera2.setImageWriter(new ImageWriter("FunImage5", 1920, 1080))
